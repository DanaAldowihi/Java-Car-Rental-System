...
try {
        c.st=c.con.prepareStatement("SELECT * FROM custmer WHERE ID=?");
       ...
       jTextField7.setText(c.rs.getString(4));
        jPasswordField1.setText(c.rs.getString(6));
        jTextField8.setText(c.rs.getString(5));
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        c.st=c.con.prepareStatement("UPDATE custmer SET name=?,phoneNumber=?,age=?,password=? ,licenseNumber=?  WHERE ID=?");
